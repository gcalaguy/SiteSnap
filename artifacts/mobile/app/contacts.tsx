...
const styles = StyleSheet.create({
  ...
  cardName: { fontSize: 15, fontFamily: "NunitoSans_600SemiBold" },
  cardCompany: { fontSize: 12, fontFamily: "NunitoSans_400Regular", marginTop: 1 },
  typeBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 16 },
  typeBadgeText: { fontSize: 11, fontFamily: "NunitoSans_600SemiBold" },
  cardInfo: { gap: 4, marginTop: 2 },
  infoRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  infoText: { fontSize: 12, fontFamily: "NunitoSans_400Regular" },
  ...
  saveBtn: { fontSize: 16, fontFamily: "NunitoSans_600SemiBold" },
  modalScroll: { flex: 1 },
