...
const styles = StyleSheet.create({
  ...
  iconBtn: { width: 36, height: 36, borderRadius: 20, alignItems: "center", justifyContent: "center" },
  ...
  newBtn: { width: 36, height: 36, borderRadius: 20, alignItems: "center", justifyContent: "center" },
  ...
  postCard: { borderRadius: 16, borderWidth: 1, padding: 14, gap: 8, overflow: "hidden" },
  postHeader: { flexDirection: "row", alignItems: "center", gap: 10 },
  avatar: { width: 36, height: 36, borderRadius: 20, alignItems: "center", justifyContent: "center" },
  avatarText: { fontSize: 13, fontFamily: "NunitoSans_700Bold" },
  authorName: { fontSize: 14, fontFamily: "NunitoSans_600SemiBold" },
  tradeBadge: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 16 },
  tradeBadgeText: { fontSize: 10, fontFamily: "NunitoSans_600SemiBold" },
  postTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  typeBadge: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 16 },
  typeText: { fontSize: 11, fontFamily: "NunitoSans_600SemiBold" },
  timeText: { fontSize: 11, fontFamily: "NunitoSans_400Regular" },
  postTitle: { fontSize: 15, fontFamily: "NunitoSans_600SemiBold", lineHeight: 21 },
  postBody: { fontSize: 13, fontFamily: "NunitoSans_400Regular", lineHeight: 19 },
  mediaBlock: { marginHorizontal: -14 },
  mediaImage: { width: "100%", aspectRatio: 16 / 9, borderRadius: 16 },
  postFooter: { flexDirection: "row", alignItems: "center", gap: 18, marginTop: 4 },
  actionBtn: { flexDirection: "row", alignItems: "center", gap: 5 },
  actionCount: { fontSize: 13, fontFamily: "NunitoSans_500Medium" },
  ...
  typeChipText: { fontSize: 13, fontFamily: "NunitoSans_500Medium" },
  textInput: {
    borderWidth: 1,
    borderRadius: 16,
