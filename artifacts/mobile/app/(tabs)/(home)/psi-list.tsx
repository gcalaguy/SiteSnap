...
const styles = (colors: ReturnType<typeof useColors>) =>
  StyleSheet.create({
    ...
    backBtn: { padding: 4 },
    title: { flex: 1, fontSize: 20, fontFamily: "NunitoSans_700Bold" },
    newBtn: { width: 34, height: 34, borderRadius: 20, alignItems: "center", justifyContent: "center" },
    emptyText: { fontSize: 13, fontFamily: "NunitoSans_400Regular", marginTop: 8 },
    ...
    projectText: { fontSize: 14, fontFamily: "NunitoSans_600SemiBold", marginBottom: 2 },
