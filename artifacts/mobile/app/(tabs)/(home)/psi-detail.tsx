        ...
        <View style={[s.section, { borderColor: colors.border, backgroundColor: colors.card }]}>
          ...
          {signatures.map((sig) => (
            <Text key={sig.id} style={[s.infoValue, { color: colors.foreground, marginTop: 8 }]}>
              {sig.firstName} {sig.lastName} <Text style={{ color: colors.mutedForeground, fontFamily: "Inter_400Regular" }}>· {new Date(sig.signedAt).toLocaleDateString()}</Text>
            </Text>
          ))}
        </View>
...
const styles = (colors: ReturnType<typeof useColors>) =>
  StyleSheet.create({
    ...
    infoGrid: { borderWidth: 1, borderRadius: 12, padding: 14, marginTop: 16, gap: 10 },
    infoItem: {},
    infoLabel: { fontSize: 11, fontFamily: "Inter_500Medium", textTransform: "uppercase", letterSpacing: 0.4 },
    infoValue: { fontSize: 14, fontFamily: "Inter_600SemiBold", marginTop: 2 },
    section: { borderWidth: 1, borderRadius: 12, padding: 14, marginTop: 12 },
    sectionTitle: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
    sectionSubtitle: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 4 },
    pill: { flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 5 },
    pillText: { fontSize: 12, fontFamily: "Inter_400Regular" },
    signBtn: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 8 },
    signBtnText: { color: "#fff", fontSize: 12, fontFamily: "Inter_600SemiBold" },
    secondaryBtn: { paddingVertical: 12, borderRadius: 10, alignItems: "center", borderWidth: 1, marginTop: 8 },
    ...
    recordBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 12, borderRadius: 10, marginTop: 12 },
    recordBtnText: { color: "#fff", fontSize: 14, fontFamily: "Inter_600SemiBold" },
    errorText: { color: "#EF4444", fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 8 },
