...
const styles = StyleSheet.create({
  ...
  scoreValue: { fontSize: 22, fontFamily: "Inter_700Bold", marginTop: 4 },
  warningBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  transcriptToggleText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  transcriptText: { fontSize: 12, fontFamily: "Inter_400Regular", lineHeight: 18, marginTop: 8 },
});
