...
const styles = StyleSheet.create({
  ...
  recordLabel: { fontSize: 13, fontFamily: "Inter_500Medium", marginTop: 16, textAlign: "center" },
  errorText: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 8, textAlign: "center" },
});
