...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontFamily: "NunitoSans_700Bold", color: "#FFFFFF", flex: 1, textAlign: "center" },
  headerSub: { fontSize: 12, fontFamily: "NunitoSans_400Regular", color: "rgba(255,255,255,0.6)", marginTop: 1 },
  newBtn: { width: 36, height: 36, borderRadius: 20, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.12)" },
  ...
  avatarText: { fontSize: 16, fontFamily: "NunitoSans_700Bold" },
  convName: { fontSize: 15, fontFamily: "NunitoSans_600SemiBold" },
  convTime: { fontSize: 11, fontFamily: "NunitoSans_400Regular" },
  convPreview: { fontSize: 13, fontFamily: "NunitoSans_400Regular" },
  unreadBadge: {
    minWidth: 20,
    height: 20,
    borderRadius: 16,
  ...
  unreadText: { fontSize: 11, fontFamily: "NunitoSans_700Bold", color: "#FFFFFF" },
  msgBubble: { borderRadius: 16, paddingHorizontal: 14, paddingVertical: 10, maxWidth: "80%" },
  msgText: { fontSize: 14, fontFamily: "NunitoSans_400Regular" },
  msgTime: { fontSize: 11, fontFamily: "NunitoSans_400Regular", marginTop: 4, alignSelf: "flex-end" },
  inputBar: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  searchInput: { flex: 1, fontSize: 15, fontFamily: "NunitoSans_400Regular" },
  userRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  userName: { fontSize: 15, fontFamily: "NunitoSans_600SemiBold" },
  userTrade: { fontSize: 13, fontFamily: "NunitoSans_400Regular" },
