...
const styles = StyleSheet.create({
  ...
  projectSelector: { flexDirection: "row", gap: spacing.sm },
  updatedRow: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: layout.gutter, paddingVertical: spacing.xs },
  updatedText: { ...typography.caption, color: "#9CA3AF" },
  sectionHeader: { paddingHorizontal: layout.gutter, paddingTop: layout.sectionGap, paddingBottom: spacing.md, flexDirection: "row", alignItems: "center", gap: 6 },
  ...
  taskTitle: { ...typography.bodyMedium },
  taskDone: { textDecorationLine: "line-through" },
  taskMeta: { flexDirection: "row", alignItems: "center", marginTop: spacing.sm, gap: spacing.xs, flexWrap: "wrap" },
  priorityDot: { width: 6, height: 6, borderRadius: 3 },
  priorityText: { ...typography.caption, fontFamily: typography.captionMedium.fontFamily },
  ...
  noProjectText: { fontSize: 15, fontFamily: "NunitoSans_500Medium", textAlign: "center", marginTop: 12 },
  noProjectSub: { fontSize: 13, fontFamily: "NunitoSans_400Regular", textAlign: "center", marginTop: 6 },
  fab: {
    position: "absolute",
    right: 16,
    flexDirection: "row",
  ...
  fabText: { fontSize: 13, fontFamily: "NunitoSans_600SemiBold" },
});
