...
const styles = StyleSheet.create({
  ...
  logo: { width: 44, height: 44, borderRadius: 16, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  logoText: { fontSize: 14, fontFamily: "NunitoSans_700Bold" },
  ...
  salaryText: { fontSize: 12, fontFamily: "NunitoSans_700Bold", color: "#8a6d1f" },
  ...
  applicantsText: { fontSize: 12, fontFamily: "NunitoSans_400Regular" },
  ...
  time: { fontSize: 11, fontFamily: "NunitoSans_400Regular" },
  title: { fontSize: 15, fontFamily: "NunitoSans_600SemiBold", lineHeight: 21 },
  body: { fontSize: 13, fontFamily: "NunitoSans_400Regular", lineHeight: 19 },
  metaRow: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 4 },
  tag: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 16, borderWidth: 1 },
  ...
  applyText: { fontSize: 13, fontFamily: "NunitoSans_700Bold", color: "#D4AF37" },
