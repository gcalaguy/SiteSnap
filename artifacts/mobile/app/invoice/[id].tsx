...
const styles = StyleSheet.create({
  ...
  invoiceTitle: { fontSize: 18, fontFamily: "NunitoSans_700Bold" },
  invoiceNum: { fontSize: 13, fontFamily: "NunitoSans_400Regular", marginTop: 4 },
  ...
  actionHint: { fontSize: 12, fontFamily: "NunitoSans_400Regular" },
  submittedBanner: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 16, borderWidth: 1, marginTop: 12 },
  submittedBannerText: { fontSize: 13, fontFamily: "NunitoSans_500Medium" },
});
