...
const s = StyleSheet.create({
  ...
  bubbleText: { fontSize: 14, fontFamily: "NunitoSans_400Regular", lineHeight: 20 },
  msgMeta: { flexDirection: "row", alignItems: "center", gap: 2, marginTop: 2, paddingHorizontal: 2 },
  metaLeft: {},
  metaRight: {},
  metaName: { fontSize: 11, fontFamily: "NunitoSans_600SemiBold" },
  metaTime: { fontSize: 10, fontFamily: "NunitoSans_400Regular" },
  replyBox: { flexDirection: "row", alignItems: "flex-end", borderWidth: 1, borderRadius: 16, paddingLeft: 14, paddingRight: 8, paddingVertical: 8, gap: 8 },
  input: { flex: 1, fontSize: 14, fontFamily: "NunitoSans_400Regular", maxHeight: 100, paddingTop: Platform.OS === "ios" ? 2 : 0 },
  sendBtn: { width: 36, height: 36, borderRadius: 20, backgroundColor: GOLD, alignItems: "center", justifyContent: "center", flexShrink: 0 },
});
