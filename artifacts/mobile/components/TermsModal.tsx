...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1, marginHorizontal: 16, marginTop: 12, borderRadius: 16, borderWidth: 1 },
  termsText: { fontSize: 13, fontFamily: "NunitoSans_400Regular", lineHeight: 20 },
  hint: {
    flexDirection: "row", alignItems: "center", gap: 6, justifyContent: "center",
    marginHorizontal: 16, paddingVertical: 8, borderRadius: 16, marginTop: 8,
  },
  hintText: { fontSize: 12, fontFamily: "NunitoSans_400Regular" },
  agreeRow: {
    flexDirection: "row", alignItems: "flex-start", gap: 12,
    marginHorizontal: 16, marginTop: 10, padding: 14, borderRadius: 16, borderWidth: 1,
  },
  checkbox: {
    width: 20, height: 20, borderRadius: 4, borderWidth: 2,
    alignItems: "center", justifyContent: "center", marginTop: 1,
  },
  agreeText: { flex: 1, fontSize: 14, fontFamily: "NunitoSans_400Regular", lineHeight: 20 },
  footer: { paddingHorizontal: 16, paddingTop: 12 },
  acceptBtn: {
    borderRadius: 16, paddingVertical: 16, alignItems: "center", justifyContent: "center",
  },
  acceptBtnText: { fontSize: 16, fontFamily: "NunitoSans_700Bold" },
});
