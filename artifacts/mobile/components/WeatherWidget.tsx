...
const styles = StyleSheet.create({
  ...
  temp: { fontSize: 20, fontFamily: "NunitoSans_700Bold" },
  divider: { width: 1, alignSelf: "stretch" },
  right: { flex: 1, gap: 2 },
  locationRow: { flexDirection: "row", alignItems: "center" },
  locationText: { fontSize: 14, fontFamily: "NunitoSans_600SemiBold", flexShrink: 1 },
  conditionText: { fontSize: 12, fontFamily: "NunitoSans_400Regular", marginTop: 2 },
  detailRow: {
    flexDirection: "row",
    alignItems: "center",
    marginTop: 6,
  },
  detailText: { fontSize: 12, fontFamily: "NunitoSans_400Regular" },
  dot: { fontSize: 12 },
  loadingText: { fontSize: 13, fontFamily: "NunitoSans_400Regular" },
});
