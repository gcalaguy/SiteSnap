...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: "#FFFFFF", fontSize: 17, fontFamily: "NunitoSans_700Bold" },
  ...
  smallBtn: { paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: 16, minWidth: 92, alignItems: "center" },
  bulkBtn: {
    flexDirection: "row",
    alignItems: "center",
