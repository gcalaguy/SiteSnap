...
const s = StyleSheet.create({
  ...
  totalLabel: { fontSize: 13, fontFamily: "NunitoSans_600SemiBold", marginTop: 2 },
  logBtn: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20 },
  logBtnText: { color: "#fff", fontSize: 13, fontFamily: "NunitoSans_600SemiBold" },
  ...
  dateField: { flexDirection: "row", alignItems: "center", gap: 10, borderWidth: 1, borderRadius: 16, paddingHorizontal: 12, paddingVertical: 12 },
  dateFieldText: { flex: 1, fontSize: 14, fontFamily: "NunitoSans_500Medium" },
  ...
  submitBtn: { marginTop: 16, borderRadius: 16, paddingVertical: 13, alignItems: "center", justifyContent: "center" },
  ...
  modalTitle: { fontSize: 15, fontFamily: "NunitoSans_700Bold" },
  modalCancel: { fontSize: 14, fontFamily: "NunitoSans_400Regular" },
  modalDone: { fontSize: 14, fontFamily: "NunitoSans_700Bold" },
  ...
  entryDate: { fontSize: 14, fontFamily: "NunitoSans_600SemiBold" },
  entryDesc: { fontSize: 12, fontFamily: "NunitoSans_400Regular", marginTop: 3, lineHeight: 17 },
  userChip: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 16 },
