...
const COMPLIANCE_CONFIG: Record<string, { label: string; bg: string; color: string; icon: React.ElementType }> = {
  compliant:     { label: "Compliant",     bg: "var(--severity-low-badge)",      color: "var(--severity-low-badge-foreground)",      icon: ShieldCheck },
  warning:       { label: "Warning",       bg: "var(--severity-medium-badge)",   color: "var(--severity-medium-badge-foreground)",   icon: AlertTriangle },
  non_compliant: { label: "Non-Compliant", bg: "var(--severity-critical-badge)", color: "var(--severity-critical-badge-foreground)", icon: ShieldAlert },
};
